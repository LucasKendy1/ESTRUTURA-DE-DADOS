//A função a seguir inicia uma matriz I com dados lidos de um arquivo. 
//Por exemplo, para iniciar uma matriz com imagem.txt, basta chamar 
//inicia(I,"imagem.txt"). Usando essa função, altere o programa de 
//coloração anterior para que ele leia a imagem de um arquivo.
